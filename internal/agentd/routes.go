...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("GET /mcp", s.handleListMCP)
	mux.HandleFunc("POST /mcp", s.handleAddMCP)
	mux.HandleFunc("PATCH /mcp/{id}", s.handlePatchMCP)
	mux.HandleFunc("DELETE /mcp/{id}", s.handleRemoveMCP)
